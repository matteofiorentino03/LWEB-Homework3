...
<body>
    <header>
        <a href="homepage_gestore.php" class="header-link">
            <div class='logo-container'>
                <img src="img/AS_Roma_Logo_2017.svg.png" alt="Logo AS Roma" class="logo">
            </div>
        </a>
        <h1><a href="homepage_gestore.php" style="color: inherit; text-decoration: none;">PLAYERBASE</a></h1> <!-- Cliccando qui si va a homepage.html -->
    ...
    <div class="main-container">
        ...
        <div class="table">
            ...
            <ul class="table-list">
                ...
                <li><a href="gestione_sconti&bonus.php">Pagina per Sconti & Bonus</a></li>
            </ul>
        </div>
    </div>
